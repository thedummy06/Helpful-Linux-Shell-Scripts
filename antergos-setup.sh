...
do
	...
	sudo pacman -Syy
	sudo pacman -S --noconfirm  archlinux-keyring antergos-keyring
...
sudo pacman -S --noconfirm bleachbit gnome-disk-utility ncdu nmap lsb_release
sudo pacman -S --noconfirm deluge hdparm hddtemp xsensors geany dhclient 
