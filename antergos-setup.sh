...
sudo pacman -S bleachbit gnome-disk-utility ncdu nmap lsb_release
sudo pacman -S deluge hdparm hddtemp xsensors geany dhclient 
sudo pacman -S hardinfo lshw iotop htop qupzilla clementine inxi
#Optional 
#sudo pacman -S steam 
#sudo pacman -S kodi 
