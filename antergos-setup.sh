...
sudo pacman -S --noconfirm hardinfo lshw iotop htop inxi rkhunter
#Optional 
...
then
	...
	sudo pacman -S --noconfirm mint-x-theme
	sudo pacman -S --noconfirm mint-x-icons
	sudo pacman -S --noconfirm numix-frost-themes
	sudo pacman -S --noconfirm numix-theme-archblue
