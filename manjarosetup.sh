...
sudo pacman -S --noconfirm hardinfo lshw hdparm hddtemp xsensors wget geany qupzilla
#Optional 
...
sudo pacman -S --noconfirm arc-icon-theme arc-maia-icon-theme 
sudo pacman -S --noconfirm delorean-dark-themes-3.9
sudo pacman -S --noconfirm elementary-xfce-icons 
sudo pacman -S --noconfirm arc-themes-maia 
sudo pacman -S --noconfirm menda-themes-dark 
sudo pacman -S --noconfirm gtk-theme-breath
else
